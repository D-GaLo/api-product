...
public class CtrlProduct {
	...
	@GetMapping
	@Operation(summary = "Consultar productos", description = "Consulta todos los productos registrados")
	public ResponseEntity<List<DtoProductListOut>> getProducts() {
		return svc.getProducts();
	}

	@GetMapping("/{id}")
	@Operation(summary = "Consultar productos", description = "Consulta un producto por su ID")
	...
	@Operation(summary = "Activar productos", description = "Activa un producto desactivado")
	public ResponseEntity<ApiResponse> enableProduct(@PathVariable Integer id) {
		return svc.enableProduct(id);
	}

	@PatchMapping("/{id}/disable")
	@Operation(summary = "Desactivar productos", description = "Desactiva un producto registrado")
